...
export const ToggleAliasingIcon = (props: JSX.SVGAttributes<SVGSVGElement>) => (
  <Icon {...props}>
    <circle
      cx="12"
      cy="12"
...
export const ToggleAliasingActiveIcon = (props: JSX.SVGAttributes<SVGSVGElement>) => (
  <Icon {...props}>
...
export const ToggleBackgroundIcon = (props: JSX.SVGAttributes<SVGSVGElement>) => (
  <Icon {...props}>
...
export const RotateIcon = (props: JSX.SVGAttributes<SVGSVGElement>) => (
  <Icon {...props}>
...
export const AddIcon = (props: JSX.SVGAttributes<SVGSVGElement>) => (
  <Icon {...props}>
    <path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z" />
  </Icon>
);

export const RemoveIcon = (props: JSX.SVGAttributes<SVGSVGElement>) => (
  <Icon {...props}>
    <path d="M19 13H5v-2h14v2z" />
  </Icon>
);

export const UncheckedIcon = (props: JSX.SVGAttributes<SVGSVGElement>) => (
  <Icon {...props}>
...
export const CheckedIcon = (props: JSX.SVGAttributes<SVGSVGElement>) => (
  <Icon {...props}>
...
export const ExpandIcon = (props: JSX.SVGAttributes<SVGSVGElement>) => (
  <Icon {...props}>
