 ...
 */
export const encoders: Record<string, CodecInfo> = {
  mozjpeg: {
    name: 'mozjpeg',
    label: mozjpeg.label,
 ...
 */
export function getEncoder(name: string): CodecInfo | undefined {
 ...
 */
export function getAllEncoders(): CodecInfo[] {
 ...
 * @returns The codec info if found, undefined otherwise
 */
export function getEncoderByExtension(
  extension: string,
): CodecInfo | undefined {
 ...
 * @returns The codec info if found, undefined otherwise
 */
export function getEncoderByMimeType(mimeType: string): CodecInfo | undefined {
