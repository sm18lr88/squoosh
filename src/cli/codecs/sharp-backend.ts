 ...
 */
export function getSharpFormats(): SharpFormat[] {
 ...
 */
export function isFormatSupportedBySharp(format: string): boolean {
  const sharpFormats: Record<string, SharpFormat> = {
    webp: 'webp',
    avif: 'avif',
    mozjpeg: 'jpeg',
    jpeg: 'jpeg',
 ...
 */
function mapFormat(format: string): SharpFormat {
  const mapping: Record<string, SharpFormat> = {
    webp: 'webp',
    avif: 'avif',
    mozjpeg: 'jpeg',
    jpeg: 'jpeg',
 ...
 */
export async function decodeWithSharp(filePath: string): Promise<ImageData> {
