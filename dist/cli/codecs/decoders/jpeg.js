...
async function initModule() {
    const module = await import('../../../../codecs/mozjpeg/dec/mozjpeg_node_dec.js');
    ...
    const wasmPath = join(dirname(fileURLToPath(import.meta.url)), '../../../../codecs/mozjpeg/dec/mozjpeg_node_dec.wasm');
