...
describe('scanFiles', () => {
    ...
    it('should throw error if file extension not allowed', async () => {
        ...
        await expect(scanFiles('/images/photo.gif', {
            extensions: ['jpg', 'png'],
            recursive: false,
    ...
    it('should scan directory with glob', async () => {
        ...
        expect(glob).toHaveBeenCalledWith('*.{jpg,png}', expect.objectContaining({
            cwd: '/images',
            absolute: true,
            nocase: true,
        }));
    ...
    it('should scan directory recursively', async () => {
        ...
        expect(glob).toHaveBeenCalledWith('**/*.{jpg,png}', expect.anything());
    });
    it('should handle single extension without braces', async () => {
        ...
        expect(glob).toHaveBeenCalledWith('*.png', expect.anything());
    });
    it('should throw error for invalid input', async () => {
        ...
        await expect(scanFiles('/images/unknown', {
            extensions: ['jpg'],
            recursive: false,
    ...
    it('should reject file with extension not in list (case insensitive)', async () => {
        ...
        await expect(scanFiles('/images/photo.BMP', {
            extensions: ['jpg', 'png'],
            recursive: false,
    ...
    it('should handle file without extension', async () => {
        ...
        await expect(scanFiles('/images/photo', {
            extensions: ['jpg', 'png'],
            recursive: false,
    ...
    it('should handle directory with many extensions', async () => {
        ...
        expect(glob).toHaveBeenCalledWith('*.{jpg,jpeg,png,webp,avif,jxl,qoi,wp2}', expect.anything());
    });
    ...
    it('should handle stat throwing ENOENT error', async () => {
        ...
        await expect(scanFiles('/nonexistent/path.jpg', {
            extensions: ['jpg'],
            recursive: false,
    ...
    it('should handle stat throwing EACCES error', async () => {
        ...
        error.code = 'EACCES';
        stat.mockRejectedValue(error);
        await expect(scanFiles('/protected/path.jpg', {
            extensions: ['jpg'],
            recursive: false,
...
describe('parseExtensions - additional edge cases', () => {
    ...
    it('should handle very long extension list', () => {
        const longList = Array(100).fill('jpg').join(',');
